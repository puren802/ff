  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
		...
		<li><a href="#login" onclick="document.getElementById('modal-wrapper').style.display='block'">LOGIN</a></li>
...
<div id="modal-wrapper" class="modal">
  ...
  <form class="modal-content animate" method="POST" action="login_check.php">
    ...
    <div class="container">
      ...
      <button type="submit" name="submit" style="width: 100px; height: 40px; color: white; background-color:#f4511e">Login</button>
	  <br>
...
<div id="modal-wrapper2" class="modal">
  ...
  <form class="modal-content animate" method="post">
	...
	<br>
	  ...
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  Man: <input type="radio" name="sex" />  Woman: <input type="radio" name="sex" /><br><br>
	  <td>생년월일</td>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <form><input type="date" name="bday"></form><br><br>
	  <td>ID</td>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
	  ...
	  <input type="button" style="height:40px; width:150px" value="Get in Touch" onClick="document.getElementById('modal-wrapper').style.display='block'">
    </div>
    <div class="col-sm-4">
